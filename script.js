const developersData = [
  ...
  },
  {
    ...
    bio: "A Ruby developer passionate about crafting delightful pplications. With a background in mobile app development and a keen eye for design, I've had the privilege of working on numerous projects, ranging from consumer apps to enterprise solutions.",
    deliveryTime: 8
  },
];
...
function renderDevelopers(developers) {
    ...
    profileLink.href = `profile.html?developer=${developer.name}`;
        ...
        const shortenedBio = developer.bio.substring(0, 150) + "...";
